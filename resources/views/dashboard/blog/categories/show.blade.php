...
@section("pagetitle", " $category->name category")
    ...
    <div class="box-header">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            <h1 class=""><span class="glyphicon glyphicon-categories"> </span>  {{$category->name}} category <small>{{$category->posts->count()}} {{($category->posts->count() <= 1)? ' Post' : ' Posts'}}</small></h1>
          </div>
          <br>
            <div class="col-md-2">
