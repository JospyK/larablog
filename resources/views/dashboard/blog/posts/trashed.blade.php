...
@section("pagetitle", " My Trashed Posts")
...
<div class="row">
 ...
 <h3 class="box-title col-md-6">Trashed Posts List</h3>
    <div class="col-md-6">
          ...
          <tbody class="hidden-xs">
            @foreach($posts as $post)
              <tr class="{{ $post->statut }}">
                ...
                <td>
                 <a href="{{route('posts.restore', $post->id)}}" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"> </span> Restore</a>
                </td>
              </tr>
            @endforeach
          </tbody>
