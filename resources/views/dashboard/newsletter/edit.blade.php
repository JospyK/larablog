      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form name="newUpdate"  action="{{route('newsletter.update', $new->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                  ...
                  <div class="row control-group">
                      <div class="form-group col-xs-12 floating-label-form-group controls">
                          <label>Subject</label>
                          <input type="text" class="form-control" placeholder="subject :" id="subject" name="subject" required data-validation-required-message="Please write a short subject."  value="{{ $new->subject}}">
                  ...
                  <div class="row control-group">
                      <div class="form-group col-xs-12 floating-label-form-group controls">
                          <label>Body</label>
                          <textarea rows="7" class="form-control" placeholder="Body" id="body" name="body" data-validation-required-message="Please write the body."> {{ $new->body}}</textarea>
                          <p class="help-block text-danger"></p>
                      </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a href="{{route('newsletter.show', $new->id)}}" class="btn btn-default"><i class="fa fa-times"></i> Discard</a>
              </div>
            </form>
            <!-- /.box-footer -->
          </div>
