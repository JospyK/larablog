                  ...
                  <div class="row control-group">
                      <div class="form-group col-xs-12 floating-label-form-group controls">
                          ...
                          <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" placeholder="Slug" id="slug" name="slug" required data-validation-required-message="Please enter the post slug." minlength="5" value="{{old('slug')}}" maxlength="100" aria-describedby="basic-addon3">
                          </div>
                          <p class="help-block text-danger"></p>
                      </div>
                  </div>
