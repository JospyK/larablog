        ...
        <div class="row">
          <div class="col-md-9">
            <section class="section extra-margins">
              <!--Section heading-->
              <h1 class="section-heading"><i class="fa fa-tag"></i> {{$tag->name}}</h1>
              <!--Section sescription-->
          ...
          <div class="col-md-3 wow fadeIn" data-wow-delay="0.2s">        
              ...
              <div class="widget-wrapper card" style="padding: 10px; margin: 20px 0px ;">
                  <h2><i class="fa fa-folder"></i> Categories</h2>
                  <hr>
              ...
              <div class="row card" style="padding: 10px; margin: 20px 0px ;">
                ...
                <div class="col-xs-12">
                  <hr>
                  @foreach ($tags as $tag)
                    <a href="{{route('blog.tag', $tag->name)}}" class="{{Request::is('blog/tag/'.$tag->name) ? 'courant' : ''}}">{{$tag->name}}</a>&nbsp
                  @endforeach
                </div>
              </div>
