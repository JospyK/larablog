              ...
              <section class="section extra-margins">
                ...
                <div class="row card" style="padding-top: 20px; margin: 15px 0px ;">
                    ...
                    <div class="col-md-7 mb-r">
                        ...
                        <p class="">by <a href="{{route('blog.users', $post->user->id)}}" class="author"><strong>{{ $post->user->last_name}} {{ $post->user->first_name}}</strong></a> on {{ date('M d, Y', strtotime($post -> created_at)) }}</p>
