...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Newsletter | {{ env('APP_URL') }}</title>
		<style type="text/css">
			/* ----- Custom Font Import ----- */
						...
						<tr>
							<td align="center" valign="top">
								...
								<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
									<tr>
										<td class="hero-subheader__title" style="font-size: 22px; padding: 40px 0 15px 0;" align="left">
									...
									<tr>
										<td align="center">
											<table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="width: 620px;">
												<tr>
													<td class="info-bullets__block" style="padding: 20px 20px 0px 20px;" align="center">
												...
												<tr>
													<td class="info-bullets__block" style="padding: 20px;" align="center">
														<table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
															<tr>
																<td class="info-bullets__icon" style="padding: 0 15px 0 0;">
									...
									<tr>
										<td align="center">
											<table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="border-top: 1px solid #eeeeee; width: 620px;">
												...
												<tr>
													<td style="color: #444444; text-align: center; font-size: 15px; padding: 10px 0 60px 0; line-height: 22px;">Copyright &copy; 2017 <a href="{{url('/home')}}" target="_blank" style="text-decoration: none; color: #444444;">{{env('APP_NAME')}}</a>. <br />All rights reserved | <a style="color: #444444; text-decoration: none; border-bottom: 1px solid #444444; " href="{{ env('APP_URL') }}/unsubscribe/{{ $receiver->email }}/{{ $receiver->code }}"> Unsubscribe</a>.</td>
												</tr>
											</table>
										</td>
									</tr>
