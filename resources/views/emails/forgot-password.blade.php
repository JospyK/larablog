											...
											<table class="container" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td class="cta-block__button" width="300" align="center" style="width: 300px;">
														<a href="{{ env('APP_URL') }}/reset/{{ $user->email }}/{{ $code }}" style="border-radius: 0px; color: #fefefe; background-color: green; text-decoration: none; padding: 15px 45px; text-transform: uppercase; display: block; text-align: center; font-size: 16px;">Reset Your Password</a>
													</td>
												</tr>
											</table>
										</td>
