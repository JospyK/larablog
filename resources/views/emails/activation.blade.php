...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Activate your account | {{ env('APP_URL') }}</title>
		<style type="text/css">
			/* ----- Custom Font Import ----- */
						...
						<tr>
							<td align="center" valign="top">
								...
								<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
									<tr>
										<td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;" align="left">Activate your account</td>
									</tr>

									<tr>
										<td class="hero-subheader__content" style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;" align="left">Hi, {{$user->first_name}}.<br/>
											If you didn't request this, you don't need to do anything; if you require assistance or more information , check the help section on this <a href="{{url('/contact')}}">link</a>.
										</td>
									</tr>
											...
											<table class="container" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td class="cta-block__button" width="300" align="center" style="width: 300px;">
														<a href="{{ env('APP_URL') }}/activate/{{ $user->email }}/{{ $code }}" style="border-radius: 0px; color: #fefefe; background-color: green; text-decoration: none; padding: 15px 45px; text-transform: uppercase; display: block; text-align: center; font-size: 16px;">Activate your account</a>
													</td>
												</tr>
											</table>
										</td>
											...
											<table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="border-top: 1px solid #eeeeee; width: 620px;">
												<tr>
													<td style="text-align: center; padding: 50px 0 10px 0;">
														<a href="#" style="font-size: 28px; text-decoration: none; color: #d5d5d5;">{{env('APP_NAME')}}</a>
													</td>
												</tr>
												...
												<tr>
													<td style="color: #d5d5d5; text-align: center; font-size: 15px; padding: 10px 0 60px 0; line-height: 22px;">Copyright &copy; 2017 <a href="{{url('/home')}}" target="_blank" style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">{{env('APP_NAME')}}</a>. <br />All rights reserved.</td>
												</tr>
											</table>
										</td>
									</tr>
