						...
						<tr>
							<td align="center" valign="top">
								...
								<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
									<tr>
										<td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;" align="left">You have received a new message from {{env('APP_NAME')}} website contact form.</td>
									</tr>
									
									<tr>
										<td class="hero-subheader__title" style="font-size: 30px; font-weight: bold; padding: 80px 0 15px 0;" align="left">Here are the details:</td>
									</tr>

									<tr>
										<td class="hero-subheader__content" style="font-size: 16px; line-height: 27px; color: #525252; padding: 0 60px 90px 0;" align="left">
												<b>Name:</b> {{$name}}<br/><br/>
												<b>Phone:</b> {{$phone}}<br/><br/>
												<b>From Email:</b> {{$email}}<br/><br/>
												<b>Message:</b> <br/><hr> {{$bodyMessage}}
										</td>
									</tr>
								</table>
								<!-- /// Hero subheader -->
